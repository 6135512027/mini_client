    ...
    return (
        <div className=" top-0 relative shadow-sm  w-full h-14 bg-black text-white flex flex-row justify-between items-center ">
            ...
            <ul className="hidden menu-list lg:flex gap-y-32 lg:flex-row  font-bold">
                <li className="menu-list-item px-10 text-lg hover:text-sky-700"><a href="/login">Login</a></li>
                ...
                <li className="menu-list-item px-10 text-bold ">|</li>
                <li className="menu-list-item px-10 text-lg text-sky-700"><a href="register">Register</a></li>
            </ul>
            <button className='py-2 px-4 text-bold hover:text-sky-700'>
                LOGOUT
            </button>
        </div>
    )
